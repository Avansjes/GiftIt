...
INSERT INTO `gebruiker` (`GebruikersID`, `Email`, `GebruikersNaam`, `WachtWoord`, `Voornaam`, `Achternaam`, `Straat`, `Huisnummer`, `Postcode`, `Stad`, `Land`, `Rol`) VALUES (1, 'jan.jansen@gmail.com', 'Jantje', 'testwachtwoord', 'Jan', 'Jansen', 'Kerkstraat', '21', '1234DE', 'Schiedam', 'Nederland', 'Gebruiker');
INSERT INTO `gebruiker` (`GebruikersID`, `Email`, `GebruikersNaam`, `WachtWoord`, `Voornaam`, `Achternaam`, `Straat`, `Huisnummer`, `Postcode`, `Stad`, `Land`, `Rol`) VALUES (2, 'familiedebie@hotmail.com', 'Jo de Bie', 'test1', 'Jo', 'de Bie', 'Markt', '6', '3221AA', 'Amsterdam', 'Nederland', 'Gebruiker');
INSERT INTO `gebruiker` (`GebruikersID`, `Email`, `GebruikersNaam`, `WachtWoord`, `Voornaam`, `Achternaam`, `Straat`, `Huisnummer`, `Postcode`, `Stad`, `Land`, `Rol`) VALUES (3, 'famgoossens@goossens.nl', 'Jan Goossens', 'wachtwoord1', 'Jan', 'Goossens', 'Grote Heistraat', '31', '2341BE', 'Rotterdam', 'Nederland', 'Gebruiker');
INSERT INTO `gebruiker` (`GebruikersID`, `Email`, `GebruikersNaam`, `WachtWoord`, `Voornaam`, `Achternaam`, `Straat`, `Huisnummer`, `Postcode`, `Stad`, `Land`, `Rol`) VALUES (4, 'blijemiesje@gmail.com', 'MeisjeMiesje', 'wachtwoord2', 'Wies', 'Klarens', 'Vrijstraat', '28A', '3727MK', 'Etten-Leur', 'Nederlands', 'Gebruiker');
INSERT INTO `gebruiker` (`GebruikersID`, `Email`, `GebruikersNaam`, `WachtWoord`, `Voornaam`, `Achternaam`, `Straat`, `Huisnummer`, `Postcode`, `Stad`, `Land`, `Rol`) VALUES (5, 'gabriellajagers@hetnet.nl', 'De jager', 'wachtwoord3', 'Gabriella', 'Jagers', 'Zellesacker', '138', '6546HH', 'Nijmegen', 'Nederlands', 'Gebruiker');
